...
"""
  ...
  for idss, d in zip(idsss, ds):
    fig1 = Figure.create(figsize=(2.1, 2.25), preamble=preamble)
    ax1 = fig1.gca()
    
    fig2 = Figure.create(figsize=(2.1, 2.25), preamble=preamble)
    ax2 = fig2.gca()
    ...
    ax1.text(*trafo1(x, -0.06), r"$\ngp$", ha="center", va="top")
    ax1.text(*trafo1(-0.07, 0.909), r"[\si{\second}]",
             ha="right", va="center")
    
    ax2.text(*trafo2(x, -0.06), r"$\ngp$", ha="center", va="top")
